...
module.exports = function (uri, cb) {
  ...
  cp.execFile(phantomjs.path, [ script, uri ], function (err, stdout, stderr) {
    if (err) {
  ...
  nightmare.on('initialized', function () {
    //console.log('INITIALISED');
    //nightmare.evaluate(function (domContentLoadedMsg) {
    //  console.log('EVALUATE AFTER INITIALISED');
    //  console.log(window.callPhantom);
    //  document.addEventListener('DOMContentLoaded', function () {
    //    //window.callPhantom('DOMContentLoaded');
    //    //page._onContentLoad = new Date();
    //    window.__DOMContentLoaded = new Date();
    //  }, false);
    //});
  });
  ...
  //  console.log('EVALUATE BEFORE GOTO', window.location.href, document.readyState);
  ...
  nightmare.goto(uri);
  //nightmare.inject('js', require('path').join(__dirname, 'spy.js')).wait();

  nightmare.evaluate(function () {
    //console.log('EVALUATE AFTER GOTO', window.location.href, document.readyState);
    //document.addEventListener('DOMContentLoaded', function () {
    //  console.log('DOMContentLoaded', arguments);
    //});
    //console.log('EVALUATE');
    //console.log(window.__DOMContentLoaded);
